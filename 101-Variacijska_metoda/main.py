...
def plot_firstPart(model="osnovni"):
    ...
    # TODO
    # RADAR KONCNA - pri t = 1 imam fiskno hitrost, spreminjam hitrost pri t=1
    # model = "radar zacetna"
...
colors = cm.viridis(np.linspace(0, 1, len(v0s)))  # Generate colors from the Viridis colormap
...
cbar = plt.colorbar(sm, ax=ax, label='v0')  # Use plt.colorbar
...
for x in range(1, 9):  # from 0 to 10 inclusive
